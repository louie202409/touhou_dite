		...
		else if(stage==5)
		{
			...
			if(move_z)
			{
				if(player_type==1)
				{
					if(0<=power && power<8)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-90),90,1));
						}
					}
					else if(8<=power && power<16)
					{
						...
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),25,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-95),25,2));
						}
					}
					else if(16<=power && power<32)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-87),60,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-93),60,1));
						}
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),25,2));
					...
					else if(32<=power && power<48)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-87),47,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-90),47,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-93),47,1));
						}
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),25,2));
					...
					else if(48<=power && power<64)
					{
						...
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),20,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-95),20,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-80),20,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-100),20,2));
						}
					}
					else if(64<=power && power<80)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-87),47,1));
						...
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-75),18,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),18,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-95),18,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-80),18,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-100),18,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-105),18,2));
						}
					}
					else if(80<=power && power<96)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-87),47,1));
					...
					else if(96<=power && power<127)
					{
						...
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-75),15,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-80),15,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),15,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-95),15,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-100),15,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-105),15,2));
						}
						if(stageticks%15==7)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-75),15,2));
					...
					else if(127<=power && power<=128)
					{
						if(stageticks%5==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-87),40,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-90),40,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-93),40,1));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-93),40,1));
						}
						if(stageticks%15==0)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-70),13,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-75),13,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-80),12,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-85),13,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-95),12,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-100),13,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-105),12,2));
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-110),12,2));
						}
						if(stageticks%15==7)
						{
							bullet_goods.push(bullet_good(player_x,player_y,4,angle_to_radiant(-70),13,2));
			...
			while(!bullet_goods.empty())
			{
				...
				bullet_goods.pop();
		       	if(top.type==1)
				{
					top.x+=cos(top.dir)*top.speed;
					top.y+=sin(top.dir)*top.speed;
				}
				else if(top.type == 2)  // 追踪子弹（平滑追踪）
				{
				    if(!enemys.empty())
				    {
				        enemy target = enemys.front();
				        
				        // 计算目标方向
				        double dx = target.x - top.x;
				        double dy = target.y - top.y;
				        double targetAngle = atan2(dy, dx);
				        
				        // 计算当前方向与目标方向的差值
				        double angleDiff = targetAngle - top.dir;
			...
			if(stageticks%120==0)
			{
				for(int i=0;i<=score/10000;i++)
				{
					enemys.push(enemy(rand()%310+20,rand()%100+20,0,1,score/100+100,1));
				}
			}
...
//	        }
    ...
    void render()
	{
		...
		else if(stage==5)
		{
			...
			textures[29+(player_type+1)/2].render(renderer,player_x-4,player_y-4-8,8,16);
			textures[31+lv].render(renderer,player_x-4-8,player_y-4+8,8,8);
			textures[31+lv].render(renderer,player_x-4+8,player_y-4+8,8,8);
	        ...
	        while(!bullet_goods.empty())
	        {
	        	bullet_good top=bullet_goods.front();
	        	bullet_goods.pop();
	        	textures[40+top.type].setAlpha(100);
	        	textures[40+top.type].render(renderer,top.x-8,top.y-8,16,16);
	        	textures[40+top.type].setAlpha(255);
	        	tmp2.push(top);
			}
			while(!tmp2.empty())
			{
			...
			if(DEBUG)
			{
				drawRect(player_x-player_size/2,player_y-player_size/2,player_size,player_size,COLOR_RED);
				
				std::queue<drop> tempDrops = drops;
				while(!tempDrops.empty())
				{
				    const drop& d = tempDrops.front();
				    drawRect(d.x - 8, d.y - 8, 16, 16, COLOR_GREEN);
				    tempDrops.pop();
				}
			}
		}
